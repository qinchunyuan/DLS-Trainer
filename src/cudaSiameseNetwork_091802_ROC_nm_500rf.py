        ...
        for s1, s2, l in zip(self.spectrum1, self.spectrum2, self.label):
            ...
            if len(peakslist1) == 1000:
                ...
                if num == k:
                    ...
                    tmp_dplist02 = self.caculate_nornalization_dp(reference_intensity, ndp_r_spec_list,
                                                                  np.array(peakslist2), np.array(ndp_spec_list2))
...
def show_test01_roc(batch_size, fpr_list, tpr_list, auc_list, acc_list, eer_list, loss, saveName):
    ...
    # style = ['r-', 'g-', 'b-', 'y-', 'r--', 'g--', 'b--', 'y--']
    for i in range(len(fpr_list)):
        plt.plot(fpr_list[i], tpr_list[i], lw=2, alpha=0.7, label=u'Epoch%2d: AUC=%.5f; ACC=%.5f; EER=%0.5f' % ((i+1)*5, auc_list[i], acc_list[i], eer_list[i]))
    plt.plot((0, 1), (0, 1), lw=1, ls='--', alpha=0.7)
    plt.xlim((-0.01, 1.02))
    plt.ylim((-0.01, 1.02))
    plt.xticks(np.arange(0, 1.1, 0.1))
...
if __name__ == '__main__':
    ...
    # # train_dataset = NewMGFDataSet('../SpectraPairsData/MgfBin250_260.mgf', '../SpectraPairsData/train_0401_91.csv', 500)
    # # test_dataset = NewMGFDataSet('../SpectraPairsData/MgfBin250_260.mgf', '../SpectraPairsData/test_0401_91.csv', 500)
    #
    # train_dataset = Dataset_RawDataset("../SpectraPairsData/0805_NP_NM_2449Bins_50RF_TRAIN.txt")
    # train_dataset = Dataset_RawDataset("../SpectraPairsData/0807_NP_NM_2449Bins_100RF_TRAIN.txt")
    # train_dataset = Dataset_RawDataset("../SpectraPairsData/0807_NP_NM_2449Bins_500RF_TRAIN.txt")
    # train_dataset = Dataset_RawDataset("../SpectraPairsData/0722_NP_TRAIN.txt")
    # train_dataset = Dataset_RawDataset("../SpectraPairsData/0722_NP_500RF_TRAIN.txt")
    # train_dataset = Dataset_RawDataset("../SpectraPairsData/0722_NP_NM_100RF_TRAIN.txt")
    # test_dataset = Dataset_RawDataset("../SpectraPairsData/0722_NP_NM_100RF_TEST.txt")
    # test_dataset = Dataset_RawDataset("../SpectraPairsData/0722_NP_500RF_TEST.txt")
    # test_dataset = Dataset_RawDataset("../SpectraPairsData/0722_NP_TEST.txt")
    # test_dataset = Dataset_RawDataset("../SpectraPairsData/0805_NP_NM_2449Bins_50RF_TEST.txt")
    # test_dataset = Dataset_RawDataset("../SpectraPairsData/0807_NP_NM_2449Bins_100RF_TEST.txt")
    test_dataset = Dataset_RawDataset("../SpectraPairsData/0807_NP_NM_2449Bins_500RF_TEST.txt")
    #
    ...
    model = "./model/080802_20_1000_NM500R_model.pkl"
